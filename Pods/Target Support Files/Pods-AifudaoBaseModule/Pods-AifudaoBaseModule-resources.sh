...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/HFSFDCommon/HFSFDCommon.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/YXFuDaoModule/YXFuDaoModule.bundle"
fi
